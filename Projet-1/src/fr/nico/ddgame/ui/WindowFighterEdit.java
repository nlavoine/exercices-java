...
public class WindowFighterEdit extends UiBox {
    ...
    private static final String STUFF_QUESTION = "*** Quelle objet voulez-vous lui équiper ?";
    ...
    public String contentLine(String data){
        ...
        String line = generateContentLine("medium", data, false);
        return line;
    }
    ...
    public String askFighterStuff(String name, String stuff){
        ...
        String content = generateFilledLine("dotted") + "\n";
        content += generateContentLine("medium", message, false) + "\n";
        content += generateContentLine("medium", question, false) + "\n";
        content += generateEmptyLine("medium");
